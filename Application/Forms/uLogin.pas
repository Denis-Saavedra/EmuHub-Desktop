...
begin
  ...
  try
    ...
    try
      ...
      Response := HTTPClient.Post('http://localhost:5000/api/Auth/Login/', TStringStream.Create(JSONBody, TEncoding.UTF8));
...
begin
  ShellExecute(0, 'OPEN', PChar('http://localhost:8080/sign-up'), nil, nil, SW_SHOWNORMAL);
end;
